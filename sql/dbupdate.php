...
if (!$isInstalled) {
    ...
    \ilPDFCompInstaller::registerRendererAvailability($preferred, $service, $purpose);
    \ilPDFCompInstaller::registerRendererAvailability($other_renderer, $service, $purpose);
}
?>